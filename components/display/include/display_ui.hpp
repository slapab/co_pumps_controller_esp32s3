...
class DisplayUI
{
 public:
  ...
  public:
  void event_gnd_floor_temp_changed(const uint8_t temp) { nvs_data.set_gnd_floor_temp(temp); }
  void event_1st_floor_temp_changed(const uint8_t temp) { nvs_data.set_1st_floor_temp(temp); }
